...
<div class='note'>
 ...
 The Raspberry Pi will not display a user interface for Home Assistant if you plug a display into it. You need to use another computer to access Home Assistant.
